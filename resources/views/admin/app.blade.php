    ...
    <div class="main-wrapper">
        ...
        <nav class="navbar navbar-expand-lg main-navbar">
            ...
            <ul class="navbar-nav navbar-right">
                <li class="nav-link">
                    <a href="" target="_blank" class="btn btn-warning text-primary">Front End</a>
                </li>
                <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                    <img alt="image" src="uploads/user.jpg" class="rounded-circle mr-1">
                    <div class="d-sm-none d-lg-inline-block text-primary">John Doe</div></a>
        ...
        <div class="main-sidebar">
            <aside id="sidebar-wrapper">
                <div class="sidebar-brand text-primary">
                    <a href="index.html" class="text-primary">Admin Panel</a>
                </div>
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="active"><a class="nav-link text-primary" href="index.html"><i class="fas fa-hand-point-right"></i> <span>Dashboard</span></a></li>
                ...
                <div class="row">
                        ...
                        <div class="card card-statistic-1">
                            ...
                            <div class="card-wrap">
                                <div class="card-header" >
                                    <h4 class="text-primary">Total News Categories</h4>
                                </div>
                                <div class="card-body">
                                    12
                                </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                        <div class="card card-statistic-1">
                            ...
                            <div class="card-wrap">
                                <div class="card-header">
                                    <h4 class="text-primary">Total News</h4>
                                </div>
                                <div class="card-body">
                                    122
                                </div>
